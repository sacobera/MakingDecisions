...
/*
  ...
  If they were, console.log 'Amy & Brittani were born in the same year'. If they were not, console.log 'Amy & Brittani
...
if (myFavoriteNumbers < 7 && myFavoriteNumbers.length > 0){
...
switch (letterGrade) {
  case "A":
    alert("The student is doing excellently.")
  break;
  case "B":
    alert("The student is doing well")
  break;
  case "C":
    alert("The student is doing alright.")
  case 'D':
    alert("The student is not doing very well.")
  case "F":
    alert("The student is failing.")
  default:
    alert("Not an eligible grade")
